...
class ReportApi {
  ...
  Future<Response<ServiceResponse>> apiReportAddnotificationPost({ 
    ...
    final _path = r'/api/report/addnotification';
    ...
    try {
      const _type = FullType(NotificationModel);
      _bodyData = notificationModel == null ? null : _serializers.serialize(notificationModel, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiReportDeletenotiDelete({ 
    int? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/report/deletenoti';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiReportGetNotiallGet({ 
    String? search,
    ...
    final _path = r'/api/report/getNotiall';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (type != null) r'type': encodeQueryParameter(_serializers, type, const FullType(TypeNotification)),
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiReportGetNotibyIdGet({ 
    int? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/report/getNotibyId';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiReportGetReportGet({ 
    DateTime? from,
    DateTime? to,
    ...
    final _path = r'/api/report/getReport';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiReportGetnotiGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/report/getnoti';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiReportUpdateSeenDelete({ 
    int? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/report/updateSeen';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiReportUpdatenotificationPost({ 
    NotificationModel? notificationModel,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/report/updatenotification';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
