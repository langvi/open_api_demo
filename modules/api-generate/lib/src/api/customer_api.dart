...
class CustomerApi {
  ...
  Future<Response<ServiceResponse>> apiCustomerAddCustomerPost({ 
    ...
    final _path = r'/api/Customer/addCustomer';
    ...
    try {
      const _type = FullType(CustomerModel);
      _bodyData = customerModel == null ? null : _serializers.serialize(customerModel, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiCustomerGetCustomerGet({ 
    bool? isOnline,
    int? idSalon,
    String? search,
    int? pageIndex,
    ...
    final _path = r'/api/Customer/getCustomer';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiCustomerGetCustomerbyIdGet({ 
    int? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Customer/getCustomerbyId';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiCustomerUpdateCustomerPut({ 
    CustomerModel? customerModel,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Customer/updateCustomer';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [ServiceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ServiceResponse>> apiCustomerUpdateavatarCustomerPut({ 
    int? customerId,
    ...
    final _path = r'/api/Customer/UpdateavatarCustomer';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
